...
def create_multilayer_perceptron_three():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
    n_hidden_2 = 256  # 2nd layer number of features
...
def create_multilayer_perceptron_five():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
    n_hidden_2 = 256  # 2nd layer number of features
    n_hidden_3 = 256  # 3rd layer number of features
...
# Deep neural network with seven hidden layers
def create_multilayer_perceptron_seven():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
    n_hidden_2 = 256  # 2nd layer number of features
    n_hidden_3 = 256  # 3rd layer number of features
    n_hidden_4 = 256  # 3rd layer number of features
    n_hidden_5 = 256  # 5th layer number of features
    n_hidden_6 = 256  # 3rd layer number of features
...
# List to store accuracies and training times of deep neural networks
accuracies=[]
times=[]
def run_deep_nn(pred, x, y):
    ...
    with tf.Session() as sess:
        ...
        accuracies.append(accuracy.eval({x: test_features, y: test_labels})*100)
        print("Accuracy: ", accuracy.eval({x: test_features, y: test_labels}))
    
# Construct model
# Neural network with two layers
print('Performance of deep neural network with two layers:')
start_time = time()
pred, x, y = create_multilayer_perceptron()
run_deep_nn(pred, x, y)
end_time = time()
times.append(end_time-start_time)
print('Time taken: ', end_time - start_time)

# Neural network with three layers
print('Performance of deep neural network with three layers:')
start_time=time()
pred, x, y = create_multilayer_perceptron_three()
run_deep_nn(pred, x, y)
end_time = time()
times.append(end_time-start_time)
print('Time taken: ', end_time - start_time)
...
print('Performance of deep neural network with five layers:')
start_time=time()
pred, x, y = create_multilayer_perceptron_five()
run_deep_nn(pred, x, y)
end_time = time()
times.append(end_time-start_time)
print('Time taken: ', end_time - start_time)

# Neural network with seven layers
print('Performance of deep neural network with seven layers:')
start_time=time()
pred, x, y = create_multilayer_perceptron_seven()
run_deep_nn(pred, x, y)
end_time = time()
times.append(end_time-start_time)
print('Time taken: ', end_time - start_time)
...
num_layers=[2,3,5,7]
plt.plot(num_layers,accuracies,'-ko')
plt.ylim(0,100)
...
# Number of layers vs time
num_layers=[2,3,5,7]
plt.plot(num_layers,times,'-ko')
plt.ylim(0,)
plt.xlabel('Number of hidden layers')
plt.ylabel('Time taken for model training (seconds)')
plt.title('Number of hidden layers vs Model training time')
plt.show()